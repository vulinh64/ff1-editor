...
public final class FxEditorState {
  ...
  public BooleanProperty heroMagicResistanceProperty() {
    return heroMagicResistance;
  }

  public boolean heroMagicResistance() {
    return heroMagicResistance.get();
  }
  ...
  public BooleanProperty enemyCriticalDefenseProperty() {
    return enemyCriticalDefense;
  }

  public boolean enemyCriticalDefense() {
    return enemyCriticalDefense.get();
  }
  ...
  public void monsterStatsEditSupplier(Supplier<List<MonsterStatsEdit>> supplier) {
    monsterStatsEditSupplier = supplier == null ? List::of : supplier;
  }

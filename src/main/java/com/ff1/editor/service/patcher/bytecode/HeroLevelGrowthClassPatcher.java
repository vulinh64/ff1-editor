...
public final class HeroLevelGrowthClassPatcher {
  ...
  public static PatcherState state(byte[] classBytes) {
    try {
      ...
      log.warn("Strong leveling up patcher state error", e);
    ...
    byte[] patched =
        classFile.transformClass(
            ...
            ClassTransform.transformingMethodBodies(
                ...
                CodeTransform.ofStateful(() -> new StrongLevelUpCodeTransform(counter))));
  ...
  private static final class StrongLevelUpCodeTransform implements CodeTransform {

    private final PatchSiteCounter counter;
    private final List<Instruction> recentInstructions = new ArrayList<>();

    private StrongLevelUpCodeTransform(PatchSiteCounter counter) {

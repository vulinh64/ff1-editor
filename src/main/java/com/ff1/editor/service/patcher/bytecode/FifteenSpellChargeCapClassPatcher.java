...
public final class FifteenSpellChargeCapClassPatcher {
  ...
  public static PatcherState state(byte[] classBytes) {
    try {
      ...
      log.warn("15 spells patcher state error", e);
    ...
    byte[] patched =
        classFile.transformClass(
            ...
            ClassTransform.transformingMethodBodies(
                ...
                CodeTransform.ofStateful(() -> new FifteenChargeCapCodeTransform(counter))));
  ...
  private static final class FifteenChargeCapCodeTransform implements CodeTransform {
    private final PatchSiteCounter counter;
    private Instruction pendingInstruction;

    private FifteenChargeCapCodeTransform(PatchSiteCounter counter) {
